 ...
 * correct without manual asset work, because it IS the research entry's own
 * title/description, not a static placeholder image someone forgot to
 * update. Mirrors projects/[slug]/opengraph-image.tsx and
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 64, fontWeight: 700, lineHeight: 1.2, display: 'flex' }}>
        {research?.title ?? 'Research not found'}
      </div>
