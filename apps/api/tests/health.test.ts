...
// The shared database this app instance reads from (matching
// vitest.config.ts's `test.env.DATABASE_URL`) is created and migrated once
// by tests/globalSetup.ts, not by this file — see that file's header.
const app = createApp();
